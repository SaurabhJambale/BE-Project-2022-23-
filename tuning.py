...
for dense_layer in dense_layers:
	for conv_layer in conv_layers:
		for neuron in neurons:
			...
			history=model.fit(X, y, epochs=3, batch_size = 32, validation_split=0.1, callbacks = [tensorboard])

			model.save('3x3x64-brass vs cartridge_brass vs copper prediction.model')
